        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Lihat Departemen</li>
                </ol>
            </div>
        </div>
        <!-- Row -->
                                        ...
                                        if(mysqli_num_rows($query)>0){
                                            while ($variabel = mysqli_fetch_assoc($query)) {
                                                echo '<tr>
                                                        ...
                                                        <td>
                                                            <a href="ubah_departemen.php?id='.$variabel['id_departemen'].'" class="btn btn-warning btn-sm">Ubah</a>
                                                            <a href="../process/h_departemen.php?id='.$variabel['id_departemen'].'" onclick="return hapus()" class="btn btn-danger btn-sm">Hapus</a>
                                                        </td>
                                                    </tr>
                                                ';
                                                $i++;
                                            ...
                                            echo '
                                                <div class="alert alert-dismissible alert-warning">
                                                    ...
                                                    <Strong>Data masih kosong</strong>. Silahkan tambah data departemen.
                                                </div>
                                            ';
                                        }
                                    ?>
